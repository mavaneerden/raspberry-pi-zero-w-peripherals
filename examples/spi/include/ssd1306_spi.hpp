...
#include "../../../src/spi/include/spi_driver.hpp"
...
public:
    ssd1306_spi_t(uint8_t spi_bus, uint8_t spi_cs, bool use_3_wire_spi = 0u);
    ssd1306_spi_t(uint8_t spi_bus, bool use_3_wire_spi = 0u);
    void initialise();
